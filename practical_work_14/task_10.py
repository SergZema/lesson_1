...
# элементом ко-торого является показатель эффективности, а индексом — ранг клетки.
# Учёные отбирают клетки по следующе-му принципу: если эффективность клетки меньше её ранга, то она не подходит.
