...
Реализуйте эти действия в коде программы и выведите в консоль итоговый список животных,
 а также покажи-те, в какой клетке сидят лев и обезьяна. Для этого используйте методы списков.
...
index =  zoo.index('lion')
print(f'Лев в {index +1} клетке.')
index =  zoo.index('monkey')
print(f'Обезьяна в {index +1} клетке.')