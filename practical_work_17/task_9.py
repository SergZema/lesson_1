...
Советы
•	Вспомните методы строк, которые изучили. Выберите из них те, которые помогут вам выполнить проверку
буквы (является ли она заглавной или нет).
•	Чтобы вернуть несколько элементов из функции, перечислите их через запятую:
return a, b
"""
#text = input("Введите строку для анализа: ")

# print("Количество заглавных букв:", sum(map(str.isupper, text)))
# print("Количество строчных букв:", sum(map(str.islower, text)))
